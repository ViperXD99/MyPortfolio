...
export const projects = [
    {key: "1",title: "Home Service Mobile Application", description: "A mobile application implemented using KOTLIN and Firebase Realtime database with google authentication where a customer can hire service providers and purchase goods that needed to get completed their service via the application.", image:home_service},
    {key: "2",title: "Sales And Inventory Management System", description: "implemented using C# and SQL to manage sales and inventory of an agricultural company to manage their inventory and sales with invoices, GRN, deliveries and reports", image:inventory_system_png},
    {key: "3",title: "Medicare Web Application", description: "Implemented using JAVA Spring Boot REST API, MySQL, and React JS where patients can channel doctors according to their specialization, access their bookings by submitting the contact number and where doctors can handle their schedules, patients, and issue prescriptions through the system.", image:home_service},
    {key: "4",title: "Home Service Mobile Application", description: "This is a mobile home service app", image:home_service},
