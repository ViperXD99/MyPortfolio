...
const ContactMe = () => {
  ...
  return (
    <div className="flex flex-col justify-top items-center max-container py-6  h-auto scroll-smooth ">
      ...
      <div className="flex flex-row gap-10 items-center mt-6">
        ...
        <p className=" cursor-pointer" onClick={contactViaEmail} >sandaruxd99@gmail.com</p>
        <button
        ...
        <p className=" cursor-pointer" onClick={contactViaEmail} >Sandaru Perera</p>
      </div>
      <p className="flex flex-row text-sm font-thin mt-28" >
        Copyright
        <span>
          <img
            src={copyright}
